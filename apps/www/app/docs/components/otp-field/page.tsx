...
export default function OTPFieldDocs() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      <ApiTable
        rows={[
          { prop: "length", type: "number", default: "6", desc: "Number of slots." },
          { prop: "invalid", type: "boolean", desc: "Paints destructive slots, shakes the group, and fires the error haptic when flipped on." },
          { prop: "value / defaultValue", type: "string", desc: "Controlled / uncontrolled code." },
          { prop: "onValueChange", type: "(value, eventDetails) => void", desc: "Fires as digits land or are deleted." },
          { prop: "onValueComplete", type: "(value, eventDetails) => void", desc: "Fires once all slots are filled — the usual submit hook." },
        ]}
        footer={
      ...
      <Notes>
        <li>
          ...
          as its digit lands, and flipping <code>invalid</code> shakes the
          group (an opacity flash under reduced motion; the destructive border
