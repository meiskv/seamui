    ...
    <main className="mx-auto max-w-3xl px-6 py-10">
        ...
        variants={[
          {
            key: "default",
            title: "Default",
            component: <VoiceControlBarDemo />,
            code: exampleSource("voice-control-bar-demo"),
            description:
          ...
          },
          {
            ...
            component: <VoiceControlBarExpand />,
            code: exampleSource("voice-control-bar-expand"),
            description:
              "Toggle chat and the pill grows a composer while squaring off from a pill into a card.",
          },
          {
            key: "widget",
            title: "Full widget",
            component: <VoiceWidgetDemo />,
            code: exampleSource("voice-widget-demo"),
            description:
              "The whole thing wired to a fake agent: state-driven visualizer, caption, and the pill.",
          },
        ]}
      />
        ...
        rows={[
          {
            prop: "expanded",
            type: "boolean",
            desc: "Controlled expanded state of the panel.",
          },
          {
            prop: "defaultExpanded",
            type: "boolean",
            default: "false",
            desc: "Uncontrolled initial state; the Trigger flips it.",
          },
          {
            prop: "onExpandedChange",
            type: "(expanded: boolean) => void",
            desc: "Called when the panel opens or closes.",
          },
        ]}
        footer={
          <>
            Props on the root <code>&lt;VoiceControlBar&gt;</code>;{" "}
            <code>Trigger</code> and <code>End</code> accept all Button props.
          </>
        }
      />
      ...
      <Notes>
        <li>
          ...
          defaults to an &ldquo;End call&rdquo; label when it renders icon-only.
        </li>
        <li>
        ...
        <li>
          ...
          <code>aria-pressed</code>) with a label that flips with the panel, and
          the panel is <code>aria-hidden</code> while collapsed so its contents
